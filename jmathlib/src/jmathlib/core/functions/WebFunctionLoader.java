...
public class WebFunctionLoader extends FunctionLoader
{
    ...
    public WebFunctionLoader()
    {
        ...
        try 
        {
            ...
            // ELLIS: InputStream    in = WebFunctionLoader.class.getResourceAsStream("../../../../../webFunctionsList.dat");
            InputStream    in = WebFunctionLoader.class.getResourceAsStream("/webFunctionsList.dat"); // ELLIS
        	//InputStream in = new FileInputStream("webFunctionsList.dat"); // ELLIS
