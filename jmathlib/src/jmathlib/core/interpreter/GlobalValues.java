...
public class GlobalValues
{
    ...
    // ELLIS: private jmathlib.core.graphics.GraphicsManager graphicsManager;  
    ...
    public GlobalValues(Interpreter _interpreter, boolean _runningStandalone)
    {
     ...
     // ELLIS: graphicsManager = new jmathlib.core.graphics.GraphicsManager();
     ...
     */
    /* ELLIS: public jmathlib.core.graphics.GraphicsManager getGraphicsManager()
    {
    ...
    public void loadPropertiesFromFile()
    {
        ...
        try 
        {
             ...
             if (!runningStandalone)
             {
                 ...
                 // ELLIS: InputStream in = GlobalValues.class.getResourceAsStream("../../../JMathLib.properties");
                 InputStream in = GlobalValues.class.getResourceAsStream("/JMathLib.properties"); // ELLIS
            	 //InputStream in = new FileInputStream("JMathLib.properties"); // ELLIS
     ...
     */
    public void storePropertiesToFile(OutputStream out)
    {
